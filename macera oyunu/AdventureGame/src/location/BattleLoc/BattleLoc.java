...
public abstract class BattleLoc extends Location{
	...
	//OLUŞTURULAN CANAVAR SAYISINA GÖRE SAVAŞ METODU
	...
	//CANAVARLARIN SAĞLIKLARINI YENİDEN SET ETME METODU
	public void setHealthyZombieVampireBear(Monster m) {
		if(m.getName().equals("Zombi")) {
			m.setHealthy(10);						
		}else if(m.getName().equals("Vampir")) {
			m.setHealthy(14);
		}else if(m.getName().equals("Ayı")) {
			m.setHealthy(20);
		}
	}
